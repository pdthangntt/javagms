...
from (select 
    ...
    from (SELECT t.id, 
        ...
        WHERE t.is_remove = 0
            ...
            AND t.register_therapy_time is not null AND t.register_therapy_site is not null AND t.register_therapy_site <> ''
            AND t.therapy_no is not null AND t.therapy_no <> ''
            AND t.confirm_results_id = '2'
