 ...
 */
@Component
public class PacPatientImportValidate implements Validator {
private static final String PHONE_NUMBER = "(^(0|\\+84)(\\s|\\.)?((3[2-9])|(5[689])|(7[06-9])|(8[1-689])|(9[0-46-9]))(\\d)(\\s|\\.)?(\\d{3})(\\s|\\.)?(\\d{3})$)|(02[4|5|7|2|6|8|9])+([0-9]{8}$)";
    ...
    public boolean supports(Class<?> type) {
        return type.equals(PacPatientImportForm.class);
    }

    @Override
    public void validate(Object o, Errors errors) {
        PacPatientImportForm form = (PacPatientImportForm) o;
        ...
        if (StringUtils.isNotEmpty(form.getOpcCode()) && errors.getFieldError("opcCode") == null && !TextUtils.removeDiacritical(form.getOpcCode().trim()).matches(CODE_REGEX)) {
            errors.rejectValue("opcCode", "opcCode.error.message", "Mã không đúng định dạng, bao gồm số, chữ, \"-\" và \"/\"");
        }
        ...
        try {
            ...
            if ((StringUtils.isNotEmpty(form.getDeathTime()) || (StringUtils.isNotEmpty(form.getCauseOfDeath()))) && (form.getRequestDeathTime() == null || form.getRequestDeathTime().equals(""))) {
        ...
        try {
            ...
            if (((form.getCauseOfDeath() != null && form.getCauseOfDeath() != null) || StringUtils.isNotEmpty(form.getRequestDeathTime())) && StringUtils.isEmpty(form.getDeathTime())) {
