 ...
 */
@Component
public class HtcConfirmValidate implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        if (StringUtils.isNotEmpty(form.getVirusLoadNumber()) && errors.getFieldError("virusLoadNumber") == null) {
            try {
                ...
                errors.rejectValue("virusLoadNumber", "virusLoadNumber.error.message", "Nồng độ virus phải là số");
            }
...
//        }
        ...
        // Số nhà/tổ/thôn/xóm không được để trống
//        if (StringUtils.isEmpty(form.getAddress()) && errors.getFieldError("address") == null) {
//            errors.rejectValue("address", "address.error.message", "Đối tượng không được để trống");
//        }
        ...
        if (StringUtils.isNotEmpty(form.getBioNameResult1())
        ...
        if (StringUtils.isNotEmpty(form.getBioNameResult2())
        ...
        if (StringUtils.isNotEmpty(form.getBioNameResult3())
        ...
        if (form.getID() != null && !form.getSourceServiceID().equals(ServiceEnum.HTC_CONFIRM.getKey()) && errors.getFieldError("code") == null) {
            ...
            if (confirm != null && !StringUtils.isEmpty(form.getCode()) && htcConfirmService.existCodeAndSiteID(form.getCode(), confirm.getSiteID(), confirm.getID())) {
                errors.rejectValue("code", "code.error.message", "Mã xét nghiệm đã tồn tại.");
            }
        }
        ...
        if (!form.getSourceID().isEmpty() && errors.getFieldError("sourceID") == null) {
...
//
        ...
        try {
            if (StringUtils.isNotEmpty(form.getConfirmTime()) && checkDateFormat(form.getConfirmTime(), "confirmTime", "Ngày XN khẳng định phải đúng định dạng ngày/tháng/năm", errors, sdfrmt)) {
                ...
                Date earlyHivDate = StringUtils.isNotEmpty(form.getEarlyHivDate()) ? sdfrmt.parse(form.getEarlyHivDate()) : null;
                Date virusLoadDate = StringUtils.isNotEmpty(form.getVirusLoadDate()) ? sdfrmt.parse(form.getVirusLoadDate()) : null;
                ...
                if (StringUtils.isNotEmpty(form.getSampleReceiveTime()) && confirmTime.compareTo(sampleReceiveTime) < 0 && errors.getFieldError("confirmTime") == null) {
                    errors.rejectValue("confirmTime", "confirmTime.error.message", "Ngày XN khẳng định không được nhỏ hơn ngày nhận mẫu");
                }
                if (StringUtils.isNotEmpty(form.getResultsReturnTime()) && confirmTime.compareTo(resultsReturnTime) > 0 && errors.getFieldError("confirmTime") == null) {
                ...
                if (StringUtils.isNotEmpty(form.getEarlyHivDate()) && confirmTime.compareTo(earlyHivDate) > 0 && errors.getFieldError("earlyHivDate") == null) {
                    errors.rejectValue("earlyHivDate", "earlyHivDate.error.message", "Ngày XN nhiễm mới HIV không được nhỏ hơn ngày XN khẳng định");
                }
                if (StringUtils.isNotEmpty(form.getVirusLoadDate()) && confirmTime.compareTo(virusLoadDate) > 0 && errors.getFieldError("virusLoadDate") == null) {
