...
public class PositiveExcel extends BaseView implements IExportExcel {
    ...
    private HtcConfirmPositiveForm form;
    private String extension;

    public PositiveExcel(HtcConfirmPositiveForm form, String extension) {
        setUseStyle(false);
        this.form = form;
    ...
    private void createHeader() throws Exception {
        ...
        sheet.setColumnWidth(0, PixelUtils.pixel2WidthUnits(150));
    ...
    private void createTable() {
        ...
        if (form.getTable() != null && form.getTable().size() > 0) {
            for (HtcConfirmPositiveTableForm item : form.getTable()) {
                createTableRow(
