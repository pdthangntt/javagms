 ...
 * @author pdthang
 */
public class PqmShiMMDExcel extends BaseView implements IExportExcel {

    private PqmExportAllForm form;
    private String extension;
    private String tab;

    public PqmShiMMDExcel(PqmExportAllForm form, String extension) {
        setUseStyle(false);
        this.form = form;
    ...
    private void createHeader() throws Exception {
        ...
        sheet.setColumnWidth(O++, PixelUtils.pixel2WidthUnits(90));
        sheet.setColumnWidth(O++, PixelUtils.pixel2WidthUnits(90));
        sheet.setColumnWidth(O++, PixelUtils.pixel2WidthUnits(90));
        sheet.setColumnWidth(O++, PixelUtils.pixel2WidthUnits(90));
        sheet.setColumnWidth(O++, PixelUtils.pixel2WidthUnits(90));
...
//        createFilterRow("Ngày xuất báo cáo", TextUtils.formatDate(new Date(), "dd/MM/yyyy"), cellIndexFilter);
    ...
    private void createTable() throws Exception {
        ...
        headers.add("Lượt trong kỳ");
        headers.add("Lượt lũy kế");
        headers.add("BN trong kỳ");
        headers.add("BN lũy kế");
        headers.add("Lượt trong kỳ");
        headers.add("Lượt lũy kế");
        headers.add("BN trong kỳ");
        headers.add("BN lũy kế");
        ...
        setMerge(index, index , 8 , 11 , true);  
        setMerge(index, index , 12 , 15 , true);  
        setMerge(index, index , 16 , 19 , true);  
        setMerge(index, index , 20 , 23 , true);  
        setMerge(index, index , 24 , 25 , true);  
