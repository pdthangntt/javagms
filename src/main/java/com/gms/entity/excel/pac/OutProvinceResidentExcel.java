...
import com.gms.entity.form.pac.PacOutProvinceResidentForm;
 ...
 * @author pdThang
 */
public class OutProvinceResidentExcel extends BaseView implements IExportExcel {

    private PacOutProvinceResidentForm form;
    private String extension;

    public OutProvinceResidentExcel(PacOutProvinceResidentForm form, String extension) {
        setUseStyle(false);
        this.form = form;
    ...
    private void createTable() {
        ...
        createTableHeaderRow("STT", "Đơn vị báo cáo", "Tiêu chí", "Hiện đang ở địa phương",
        ...
        for (Map.Entry<String, HashMap<String, PacOutProvinceResidentTable>> entry : form.getItems().entrySet()) {
            String key = entry.getKey();
            HashMap<String, PacOutProvinceResidentTable> value = entry.getValue();

            int index = getLastRowNumber();
            createTableRow(i++, form.getOptions().get("provinces").get(key),
                    "Ca ngoại tỉnh theo hộ khẩu",
                    value.get("permanent").getDangODiaPhuong(),
                    value.get("permanent").getDiLamAnXa(),
                    value.get("permanent").getDiTrai(),
                    value.get("permanent").getChuyenDiNoiKhac(),
                    value.get("permanent").getChuyenTrongTinh(),
                    value.get("permanent").getMatDau(),
                    value.get("permanent").getChuaXacDinhDuoc(),
                    value.get("permanent").getKhongCoThucTe(),
                    value.get("permanent").getUnclear(),
                    value.get("permanent").getSum()
            );

            createTableRow("", "", "Ca mới, chưa chuyển quản lý",
                    value.get("notmanage").getDangODiaPhuong(),
                    value.get("notmanage").getDiLamAnXa(),
                    value.get("notmanage").getDiTrai(),
                    value.get("notmanage").getChuyenDiNoiKhac(),
                    value.get("notmanage").getChuyenTrongTinh(),
                    value.get("notmanage").getMatDau(),
                    value.get("notmanage").getChuaXacDinhDuoc(),
                    value.get("notmanage").getKhongCoThucTe(),
                    value.get("notmanage").getUnclear(),
                    value.get("notmanage").getSum()
            );
            createTableRow("", "", "Ca đã chuyển quản lý",
                    value.get("hasmanage").getDangODiaPhuong(),
                    value.get("hasmanage").getDiLamAnXa(),
                    value.get("hasmanage").getDiTrai(),
                    value.get("hasmanage").getChuyenDiNoiKhac(),
                    value.get("hasmanage").getChuyenTrongTinh(),
                    value.get("hasmanage").getMatDau(),
                    value.get("hasmanage").getChuaXacDinhDuoc(),
                    value.get("hasmanage").getKhongCoThucTe(),
        ...
        createTableRowBold("Tổng cộng", "", "Ca ngoại tỉnh theo hộ khẩu",
                form.getTotal(form.getItems(), "permanent").getDangODiaPhuong(),
                form.getTotal(form.getItems(), "permanent").getDiLamAnXa(),
                form.getTotal(form.getItems(), "permanent").getDiTrai(),
                form.getTotal(form.getItems(), "permanent").getChuyenDiNoiKhac(),
                form.getTotal(form.getItems(), "permanent").getChuyenTrongTinh(),
                form.getTotal(form.getItems(), "permanent").getMatDau(),
                form.getTotal(form.getItems(), "permanent").getChuaXacDinhDuoc(),
                form.getTotal(form.getItems(), "permanent").getKhongCoThucTe(),
        ...
        createTableRowBold("", "", "Ca mới, chưa chuyển quản lý",
                form.getTotal(form.getItems(), "notmanage").getDangODiaPhuong(),
                form.getTotal(form.getItems(), "notmanage").getDiLamAnXa(),
                form.getTotal(form.getItems(), "notmanage").getDiTrai(),
                form.getTotal(form.getItems(), "notmanage").getChuyenDiNoiKhac(),
                form.getTotal(form.getItems(), "notmanage").getChuyenTrongTinh(),
                form.getTotal(form.getItems(), "notmanage").getMatDau(),
                form.getTotal(form.getItems(), "notmanage").getChuaXacDinhDuoc(),
                form.getTotal(form.getItems(), "notmanage").getKhongCoThucTe(),
        ...
        createTableRowBold("", "", "Ca đã chuyển quản lý",
                form.getTotal(form.getItems(), "hasmanage").getDangODiaPhuong(),
                form.getTotal(form.getItems(), "hasmanage").getDiLamAnXa(),
                form.getTotal(form.getItems(), "hasmanage").getDiTrai(),
                form.getTotal(form.getItems(), "hasmanage").getChuyenDiNoiKhac(),
                form.getTotal(form.getItems(), "hasmanage").getChuyenTrongTinh(),
                form.getTotal(form.getItems(), "hasmanage").getMatDau(),
                form.getTotal(form.getItems(), "hasmanage").getChuaXacDinhDuoc(),
                form.getTotal(form.getItems(), "hasmanage").getKhongCoThucTe(),
