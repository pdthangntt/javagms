...
import com.gms.entity.form.pac.PacOutProvinceTreatmentForm;
 ...
 * @author pdThang
 */
public class OutProvinceTreatmentExcel extends BaseView implements IExportExcel {

    private PacOutProvinceTreatmentForm form;
    private String extension;

    public OutProvinceTreatmentExcel(PacOutProvinceTreatmentForm form, String extension) {
        setUseStyle(false);
        this.form = form;
    ...
    private void createTable() {
        ...
        //Tiêu đề
        createTableHeaderRow("TT", "Đơn vị báo cáo", "Tiêu chí", "Đang điều trị",
                "Chưa điều trị", "Chờ điều trị",
                "Bỏ điều trị",
                "Mất dấu", "Tử vong", "Chưa có thông tin",
                "Không có thông tin", "Tổng");

        int i = 1;
        // loop to create row content
        for (Map.Entry<String, HashMap<String, PacOutProvinceTreatmentTable>> entry : form.getItems().entrySet()) {
            ...
            createTableRow(i++, form.getOptions().get("provinces").get(key),
                    ...
                    value.get("permanent").getDangdieutri(),
                    value.get("permanent").getChuadieutri(),
                    value.get("permanent").getChodieutri(),
                    value.get("permanent").getBodieutri(),
                    value.get("permanent").getMatdau(),
                    value.get("permanent").getTuvong(),
                    value.get("permanent").getChuacothongtin(),
                    value.get("permanent").getKhongthongtin(),
                    value.get("permanent").getSum()
            );

            createTableRow("", "", "Ca mới, chưa chuyển quản lý",
                    value.get("notmanage").getDangdieutri(),
                    value.get("notmanage").getChuadieutri(),
                    value.get("notmanage").getChodieutri(),
                    value.get("notmanage").getBodieutri(),
                    value.get("notmanage").getMatdau(),
                    value.get("notmanage").getTuvong(),
                    value.get("notmanage").getChuacothongtin(),
                    value.get("notmanage").getKhongthongtin(),
                    value.get("notmanage").getSum()
            );
            createTableRow("", "", "Ca đã chuyển quản lý",
                    value.get("hasmanage").getDangdieutri(),
                    value.get("hasmanage").getChuadieutri(),
                    value.get("hasmanage").getChodieutri(),
                    value.get("hasmanage").getBodieutri(),
                    value.get("hasmanage").getMatdau(),
                    value.get("hasmanage").getTuvong(),
                    value.get("hasmanage").getChuacothongtin(),
        ...
        createTableRowBold("Tổng cộng", "", "Ca ngoại tỉnh theo hộ khẩu",
                form.getTotal(form.getItems(), "permanent").getDangdieutri(),
                form.getTotal(form.getItems(), "permanent").getChuadieutri(),
                form.getTotal(form.getItems(), "permanent").getChodieutri(),
                form.getTotal(form.getItems(), "permanent").getBodieutri(),
                form.getTotal(form.getItems(), "permanent").getMatdau(),
                form.getTotal(form.getItems(), "permanent").getTuvong(),
                form.getTotal(form.getItems(), "permanent").getChuacothongtin(),
        ...
        createTableRowBold("", "", "Ca mới, chưa chuyển quản lý",
                form.getTotal(form.getItems(), "notmanage").getDangdieutri(),
                form.getTotal(form.getItems(), "notmanage").getChuadieutri(),
                form.getTotal(form.getItems(), "notmanage").getChodieutri(),
                form.getTotal(form.getItems(), "notmanage").getBodieutri(),
                form.getTotal(form.getItems(), "notmanage").getMatdau(),
                form.getTotal(form.getItems(), "notmanage").getTuvong(),
                form.getTotal(form.getItems(), "notmanage").getChuacothongtin(),
        ...
        createTableRowBold("", "", "Ca đã chuyển quản lý",
                form.getTotal(form.getItems(), "hasmanage").getDangdieutri(),
                form.getTotal(form.getItems(), "hasmanage").getChuadieutri(),
                form.getTotal(form.getItems(), "hasmanage").getChodieutri(),
                form.getTotal(form.getItems(), "hasmanage").getBodieutri(),
                form.getTotal(form.getItems(), "hasmanage").getMatdau(),
                form.getTotal(form.getItems(), "hasmanage").getTuvong(),
                form.getTotal(form.getItems(), "hasmanage").getChuacothongtin(),
