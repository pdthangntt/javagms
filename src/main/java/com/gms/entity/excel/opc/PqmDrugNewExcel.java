 ...
 * @author pdThang
 */
public class PqmDrugNewExcel extends BaseView implements IExportExcel {

    private PqmDrugNewForm form;
    private String extension;

    public PqmDrugNewExcel(PqmDrugNewForm form, String extension) {
        this.useStyle = true;
        this.form = form;
    ...
    private void createHeader() throws Exception {
        ...
        createRow();
        createTitleRow("Danh sách báo cáo tình hình sử dụng và tồn kho thuốc ARV (HMED)"); 
        createRow();
    ...
    private void createTable() throws Exception {
        ...
        createTableHeaderRow(
                "STT", "Tên cơ sở", "Tên thuốc", "Nguồn", "Đơn vị tính",
                "Tồn đầu kỳ",
                "Nhập định kỳ",
                "Nhập khác",
        ...
        if (form.getItems() != null && !form.getItems().isEmpty()) {
            for (PqmDrugNewEntity item : form.getItems()) {
                createTableRow(i++,
            ...
            createTableHeaderRow(
                    "Không có thông tin");
            setMerge(index, index, 0, 11, true);
