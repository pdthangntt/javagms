 ...
 * @author vvthanh
 */
public class PqmArvImportForm extends BaseEntity implements Serializable {
    ...
    private String patientPhone; //Giới tính
    ...
    private String insuranceNo; //A12.1 Tỉnh / Thành phố
