...
public class VisitBookForm {
    ...
    private List<VisitBookTableForm> table;
    ...
    public List<VisitBookTableForm> getTable() {
        return table;
    }

    public void setTable(List<VisitBookTableForm> table) {
        this.table = table;
    }
