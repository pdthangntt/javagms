...
/**
 *  Bảng 01 Số bạn tình bạn chích được giới thiệu và đồng ý xét nghiệm qua kênh "Theo dấu bạn tình bạn chích" 
 * 
 * @author TrangBN
 */
public class MerTable01Form implements Serializable {

    private String status; // trạng thái giới thiệu hoặc đồng ý
    ...
    private String agreePreTest; // Giới tính
    private String advisoryTime; // Thời gian TVXN
    private String preTestTime; // Thời gian XNSL
    ...
    public String getAgreePreTest() {
        return agreePreTest;
    }

    public void setAgreePreTest(String agreePreTest) {
        this.agreePreTest = agreePreTest;
    }
