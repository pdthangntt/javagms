 ...
 * @author NamAnh_HaUI
 */
public class TransferSuccessForm {
    ...
    private List<TransferSuccessTableForm> table;
    private Long siteID;
    ...
    public List<TransferSuccessTableForm> getTable() {
        return table;
    }

    public void setTable(List<TransferSuccessTableForm> table) {
        this.table = table;
    }
