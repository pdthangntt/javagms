...
/**
 * Form table bảng người nhiễm phát hiện theo BHYT
 *
 * @author TrangBN
 */
public class DetectHivInsuranceForm extends DetectHivForm {
    ...
    //table
    private List<TableDetectHivInsuranceForm> table;
    ...
    public List<TableDetectHivInsuranceForm> getTable() {
        return table;
    }

    public void setTable(List<TableDetectHivInsuranceForm> table) {
        this.table = table;
    }
    ...
    public int getOther() {
        int total = 0;
        for (TableDetectHivInsuranceForm item : table) {
            total += item.getOther();
        }
        return total;
    }
    ...
    public String getYesPercent() {
        return TextUtils.toPercent(this.getYes(), this.sum);
    }

    public String getNoPercent() {
        return TextUtils.toPercent(this.getNo(), this.sum);
    }
