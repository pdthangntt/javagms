 ...
 * @author pdThang
 */
public class PacOutProvinceGenderForm extends BaseForm {
    ...
    private Map<String, HashMap<String, PacOutProvinceGenderTable>> items;
    private PacOutProvinceGenderTableTotal tableTotal;

    public static int getSum(HashMap<String, PacOutProvinceGenderTable> item) {
        int sum = 0;

        for (Map.Entry<String, PacOutProvinceGenderTable> entry1 : item.entrySet()) {
            PacOutProvinceGenderTable value = entry1.getValue();
    ...
    public PacOutProvinceGenderTableTotal getTableTotal() {
        return tableTotal;
    }

    public void setTableTotal(PacOutProvinceGenderTableTotal tableTotal) {
    ...
    public Map<String, HashMap<String, PacOutProvinceGenderTable>> getItems() {
        return items;
    }

    public void setItems(Map<String, HashMap<String, PacOutProvinceGenderTable>> items) {
        this.items = items;
    }
