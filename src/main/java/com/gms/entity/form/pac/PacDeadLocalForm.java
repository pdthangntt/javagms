 ...
 * @author DSNAnh
 */
public class PacDeadLocalForm extends DetectHivForm {
    ...
    private List<TablePacDeadForm> table;
    ...
    public List<TablePacDeadForm> getTable() {
        return table;
    }

    public void setTable(List<TablePacDeadForm> table) {
        this.table = table;
    }

    public int getOther() {
        int total = 0;
        for (TablePacDeadForm item : table) {
            total += item.getOther();
        }
        return total;
    }
