 ...
 * @author pdThang
 */
public class PacDetectHivTreatmentFrom  extends DetectHivForm  {
    ...
    //table
    private List<PacDetectHivTreatmentTableForm> table;
    ...
    public List<PacDetectHivTreatmentTableForm> getTable() {
        return table;
    }

    public void setTable(List<PacDetectHivTreatmentTableForm> table) {
        this.table = table;
    }
}
