 ...
 * @author DSNAnh
 */
public class TablePacDeadForm implements Serializable, Cloneable {
    ...
    private int female;
    private int other;
    private List<TablePacDeadForm> childs;
    ...
    public List<TablePacDeadForm> getChilds() {
        return childs;
    }

    public void setChilds(List<TablePacDeadForm> childs) {
        this.childs = childs;
    }
    ...
    @Override
    public TablePacDeadForm clone() throws CloneNotSupportedException {
        return (TablePacDeadForm) super.clone();
    }
