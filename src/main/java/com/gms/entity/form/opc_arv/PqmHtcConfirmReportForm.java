 ...
 *
 */
public class PqmHtcConfirmReportForm extends BaseForm {
    ...
    private List<PqmHtcConfirmReportTable> items;
    private String siteLabel;
    private HashMap<String, String> siteOptions;

    public List<PqmHtcConfirmReportTable> getItems() {
        return items;
    }

    public void setItems(List<PqmHtcConfirmReportTable> items) {
        this.items = items;
    }
