 ...
 *
 */
public class PqmDrugNewApiForm extends BaseForm {
    ...
    List<PqmDrugPlanDataEntity> items;
    ...
    public List<PqmDrugPlanDataEntity> getItems() {
        return items;
    }

    public void setItems(List<PqmDrugPlanDataEntity> items) {
        this.items = items;
    }
