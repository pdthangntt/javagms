...
public class ViralGridForm {
    ...
    private HashMap<String, String> countTimeVirals;
    ...
    public HashMap<String, String> getCountTimeVirals() {
        return countTimeVirals;
    }

    public void setCountTimeVirals(HashMap<String, String> countTimeVirals) {
        this.countTimeVirals = countTimeVirals;
    }
