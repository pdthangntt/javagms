 ...
 *
 */
public class PqmEstimateForm extends BaseForm {
    ...
    private List<PqmEstimateTable> items;
    private List<PqmDrugEstimateDataEntity> itemAPI;
    ...
    public List<PqmDrugEstimateDataEntity> getItemAPI() {
        return itemAPI;
    }

    public void setItemAPI(List<PqmDrugEstimateDataEntity> itemAPI) {
    ...
    public List<PqmEstimateTable> getItems() {
        return items;
    }

    public void setItems(List<PqmEstimateTable> items) {
        this.items = items;
    }
