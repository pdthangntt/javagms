 ...
 *
 */
public class PqmeLMISEForm extends BaseForm {
    ...
    private List<PqmeLMISETable> items;
    private List<PqmDrugeLMISEDataEntity> itemAPI;
    ...
    public List<PqmeLMISETable> getItems() {
        return items;
    }

    public void setItems(List<PqmeLMISETable> items) {
        this.items = items;
    }

    public List<PqmDrugeLMISEDataEntity> getItemAPI() {
        return itemAPI;
    }

    public void setItemAPI(List<PqmDrugeLMISEDataEntity> itemAPI) {
