...
/**
 * Giám sát phát hiện -> Báo cáo tử vong
 *
 * @author Văn Thành
 */
@Controller(value = "report_pac_dead")
public class PacDeadController extends BaseController {

    protected static final String PDF_FILE_NAME = "DS Nguoi nhiem tu vong_";
    ...
    private PacDeadForm getData(String requestDeathTimeFrom, String requestDeathTimeTo, String code, String name, String blood, String updateTimeFrom, String updateTimeTo, String addressFilter, String confirmTimeFrom, String confirmTimeTo, String inputTimeFrom, String inputTimeTo,
        ...
        PacDeadForm form = new PacDeadForm();
        ...
        if (!isVAAC()) {
            switch (managestatus) {
                case "-1":
                    ...
                    break;
                case "1":
                    form.setTitle("Danh sách người nhiễm tử vong chưa rà soát ");
                    break;
                case "2":
                    form.setTitle("Danh sách người nhiễm tử vong cần rà soát ");
                    break;
                case "3":
                    form.setTitle("Danh sách người nhiễm tử vong đã rà soát ");
                    break;
                case "4":
                    form.setTitle("Danh sách người nhiễm tử vong được quản lý ");
                    break;
                default:
                    form.setTitle("");
            }
        }
        form.setFileName("DanhSachNguoiNhiemTuVong_" + "_" + TextUtils.formatDate(new Date(), "hhmm_ddMMyyyy"));
        ...
        PacPatientDeadSearch search = new PacPatientDeadSearch();
    ...
    @GetMapping(value = {"/pac-dead/index.html"})
    public String actionIndex(Model model,
        ...
        PacDeadForm form = getData(requestDeathTimeFrom, requestDeathTimeTo, code, name, blood, updateTimeFrom, updateTimeTo, addressFilter,
        ...
        DataPage<PacPatientInfoEntity> dataPage = pacPatientService.findDead(form.getSearch());
        ...
        model.addAttribute("title", "Danh sách người nhiễm tử vong");
        ...
        return "report/pac/pac-dead";
    }

    @GetMapping(value = {"/pac-dead/email.html"})
    public String actionSendEmail(Model model,
        ...
        sendEmailAtachmentExcel(
                ...
                "Danh sách người nhiễm tử vong",
                EmailoutboxEntity.TEMPLATE_PAC_DEAD,
                context,
                new DeadExcel(form, EXTENSION_EXCEL_X));
    ...
    @GetMapping(value = {"/pac-dead/excel.html"})
    public ResponseEntity<InputStreamResource> actionExportExcel(
        ...
        form.setAllProvincesName(allProvinces);
        form.setItems(dataPage.getData());
        return exportExcel(new DeadExcel(form, EXTENSION_EXCEL_X));
    }

    @GetMapping(value = {"/pac-dead/pdf.html"})
    public ResponseEntity<InputStreamResource> actionIn(Model model,
            ...
            @RequestParam(name = "page", required = false, defaultValue = "1") int page,
            @RequestParam(name = "size", required = false, defaultValue = "999999") int size) throws Exception {
        PacDeadForm form = getData(requestDeathTimeFrom, requestDeathTimeTo, code, name, blood, updateTimeFrom, updateTimeTo, addressFilter, confirmTimeFrom,
        ...
        return exportPdf(PDF_FILE_NAME + TextUtils.removeDiacritical(getCurrentUser().getSite().getShortName()), "report/pac/pac-dead-pdf.html", context);
    }
}
