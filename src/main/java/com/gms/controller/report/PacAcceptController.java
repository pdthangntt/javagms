...
import com.gms.entity.excel.pac.AcceptExcel;
 ...
 * @author pdThang
 */
@Controller(value = "report_pac_accept")
public class PacAcceptController extends BaseController {
    ...
    @GetMapping(value = {"/pac-accept/pdf.html"})
    public ResponseEntity<InputStreamResource> actionIn(Model model,
        ...
        PacAcceptForm form = getData(ID, siteConfirmID, siteTreatmentFacilityID, addressFilter, tab, fullname, yearOfBirth, confirmTimeFrom, confirmTimeTo, permanentProvinceID, permanentDistrictID, permanentWardID, genderID, statusOfResidentID, identityCard, healthInsuranceNo);
        ...
        return exportPdf("DS Nguoi Nhiem Da Ra Soat", "report/pac/pac-accept.html", context);
     ...
     * @return
     */
    private PacAcceptForm getData(String ID, String siteConfirmID, String siteTreatmentFacilityID, String addressFilter, String tab, String fullname, Integer yearOfBirth, String confirmTimeFrom, String confirmTimeTo, String permanentProvinceID, String permanentDistrictID, String permanentWardID, String genderID, String statusOfResidentID, String identityCard, String healthInsuranceNo) {
...
//        search.setProvinceID(currentUser.getSite().getProvinceID());
        ...
        PacAcceptForm form = new PacAcceptForm();
        form.setSearch(search);
        form.setOptions(getOptions());
        form.setItems(pacPatientService.findAccept(form.getSearch()).getData());
        form.setProvinceNames(provinceNames);
        form.setIsVAAC(isVAAC());
        form.setTitle("Danh sách người nhiễm đã rà soát tại địa phương");
        form.setFileName("DanhSachNguoiNhiemDaRaSoat_" + "_" + TextUtils.formatDate(new Date(), "hhmm_ddMMyyyy"));
    ...
    @GetMapping(value = {"/pac-accept/excel.html"})
    public ResponseEntity<InputStreamResource> actionPositiveExcel(
        ...
        return exportExcel(new AcceptExcel(form, EXTENSION_EXCEL_X));
    }

    @GetMapping(value = {"/pac-accept/email.html"})
    public String actionPositiveEmail(
        ...
        sendEmailAtachmentExcel(
                ...
                String.format("Danh sách người nhiễm đã rà soát tại địa phương ( %s)", form.getConfirmTime()),
                EmailoutboxEntity.TEMPLATE_PAC_ACCEPT,
                context,
                new AcceptExcel(form, EXTENSION_EXCEL_X));
