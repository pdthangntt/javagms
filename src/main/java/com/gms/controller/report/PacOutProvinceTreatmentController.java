...
import com.gms.entity.excel.pac.OutProvinceTreatmentExcel;
 ...
 * @author pdThang
 */
@Controller(value = "pacOutProvinceTreatment")
public class PacOutProvinceTreatmentController extends BaseController {
    ...
    private PacOutProvinceTreatmentForm getData(
        ...
        PacOutProvinceTreatmentForm form = new PacOutProvinceTreatmentForm();
        form.setFileName("BaoCaoNgoaiTinhTheoTrangThaiDieuTri_" + TextUtils.formatDate(new Date(), "hhmm_ddMMyyyy"));
        form.setTitle("Báo cáo người nhiễm ngoại tỉnh theo trạng thái điều trị");
        ...
        form.setItems(pacPatientRepositoryImpl.getDataOutprovinceTreatment(provinceIDs,
        ...
        PacOutProvinceTreatmentTable table = new PacOutProvinceTreatmentTable();
        for (Map.Entry<String, HashMap<String, PacOutProvinceTreatmentTable>> entry : form.getItems().entrySet()) {
            ...
            for (Map.Entry<String, PacOutProvinceTreatmentTable> entry1 : value.entrySet()) {
                PacOutProvinceTreatmentTable value1 = entry1.getValue();

                table.setDangdieutri(table.getDangdieutri() + value1.getDangdieutri());
                table.setChuadieutri(table.getChuadieutri() + value1.getChuadieutri());
                table.setChodieutri(table.getChodieutri() + value1.getChodieutri());
                table.setBodieutri(table.getBodieutri() + value1.getBodieutri());
                table.setMatdau(table.getMatdau() + value1.getMatdau());
                table.setTuvong(table.getTuvong() + value1.getTuvong());
                table.setChuacothongtin(table.getChuacothongtin() + value1.getChuacothongtin());
                table.setKhongthongtin(table.getKhongthongtin() + value1.getKhongthongtin());
            }
        }
        form.setTable(table);
    ...
    @GetMapping(value = {"/pac-out-province-treatment/index.html"})
    public String actionIndex(Model model,
        ...
        PacOutProvinceTreatmentForm form = getData(updateTimeFrom, updateTimeTo,
                patientStatus,
        ...
        return "report/pac/out-province-treatment";
    }

    @GetMapping(value = {"/pac-out-province-treatment/excel.html"})
    public ResponseEntity<InputStreamResource> actionPositiveExcel(
        ...
        return exportExcel(new OutProvinceTreatmentExcel(form, EXTENSION_EXCEL_X));
    }

    @GetMapping(value = {"/pac-out-province-treatment/mail.html"})
    public String actionSendEmail(Model model, RedirectAttributes redirectAttributes,
        ...
        if (currentUser.getUser().getEmail() == null || "".equals(currentUser.getUser().getEmail())) {
            ...
            return redirect(UrlUtils.pacOutProvinceTreatment("index"));
        }
        PacOutProvinceTreatmentForm form = getData(updateTimeFrom, updateTimeTo,
                patientStatus,
                manageTimeFrom, manageTimeTo,
        ...
        sendEmailAtachmentExcel(
                ...
                context,
                new OutProvinceTreatmentExcel(form, EXTENSION_EXCEL_X));
    ...
    @GetMapping(value = {"/pac-out-province-treatment/pdf.html"})
    public ResponseEntity<InputStreamResource> actionPdf(
        ...
        return exportPdf(form.getFileName(), "report/pac/out-province-treatment-pdf.html", context);
    }
