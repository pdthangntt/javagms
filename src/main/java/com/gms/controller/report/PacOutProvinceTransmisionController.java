...
import com.gms.entity.excel.pac.OutProvinceTransmissionExcel;
 ...
 * @author pdThang
 */
@Controller(value = "pacOutProvinceTransmission")
public class PacOutProvinceTransmisionController extends BaseController {
    ...
    private PacOutProvinceTransmissionForm getData(
        ...
        PacOutProvinceTransmissionForm form = new PacOutProvinceTransmissionForm();
        form.setFileName("BaoCaoNgoaiTinhTheoDuongLay_" + TextUtils.formatDate(new Date(), "hhmm_ddMMyyyy"));
        form.setTitle("Báo cáo người nhiễm ngoại tỉnh theo đường lây nhiễm");
        ...
        form.setItems(pacPatientRepositoryImpl.getDataOutprovinceTransmission(provinceIDs,
        ...
        PacOutProvinceTransmissionTable table = new PacOutProvinceTransmissionTable();
        for (Map.Entry<String, HashMap<String, PacOutProvinceTransmissionTable>> entry : form.getItems().entrySet()) {
            ...
            for (Map.Entry<String, PacOutProvinceTransmissionTable> entry1 : value.entrySet()) {
                PacOutProvinceTransmissionTable value1 = entry1.getValue();
                table.setBlood(table.getBlood() + value1.getBlood());
                table.setSexuality(table.getSexuality() + value1.getSexuality());
                table.setMomtochild(table.getMomtochild() + value1.getMomtochild());
                table.setUnclear(table.getUnclear() + value1.getUnclear());
                table.setNoinformation(table.getNoinformation() + value1.getNoinformation());
    ...
    @GetMapping(value = {"/pac-out-province-transmission/index.html"})
    public String actionIndex(Model model,
        ...
        PacOutProvinceTransmissionForm form = getData(updateTimeFrom, updateTimeTo,
                patientStatus,
        ...
        return "report/pac/out-province-transmission";
    }

    @GetMapping(value = {"/pac-out-province-transmission/excel.html"})
    public ResponseEntity<InputStreamResource> actionPositiveExcel(
        ...
        return exportExcel(new OutProvinceTransmissionExcel(form, EXTENSION_EXCEL_X));
    }

    @GetMapping(value = {"/pac-out-province-transmission/mail.html"})
    public String actionSendEmail(Model model, RedirectAttributes redirectAttributes,
        ...
        if (currentUser.getUser().getEmail() == null || "".equals(currentUser.getUser().getEmail())) {
            ...
            return redirect(UrlUtils.pacOutProvinceTransmission("index"));
        }
        PacOutProvinceTransmissionForm form = getData(updateTimeFrom, updateTimeTo,
                patientStatus,
                manageTimeFrom, manageTimeTo,
        ...
        sendEmailAtachmentExcel(
                ...
                context,
                new OutProvinceTransmissionExcel(form, EXTENSION_EXCEL_X));
    ...
    @GetMapping(value = {"/pac-out-province-transmission/pdf.html"})
    public ResponseEntity<InputStreamResource> actionPdf(
        ...
        return exportPdf(form.getFileName(), "report/pac/out-province-transmission-pdf.html", context);
    }
