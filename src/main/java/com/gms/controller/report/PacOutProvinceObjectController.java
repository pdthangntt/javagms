...
import com.gms.entity.excel.pac.OutProvinceObjectExcel;
 ...
 * @author pdThang
 */
@Controller(value = "pacOutProvinceObject")
public class PacOutProvinceObjectController extends BaseController {
    ...
    private PacOutProvinceObjectForm getData(
        ...
        PacOutProvinceObjectForm form = new PacOutProvinceObjectForm();
        form.setFileName("BaoCaoNgoaiTinhTheoDoiTuong_" + TextUtils.formatDate(new Date(), "hhmm_ddMMyyyy"));
        form.setTitle("Báo cáo người nhiễm ngoại tỉnh theo đối tượng");
        ...
        form.setItems(pacPatientRepositoryImpl.getDataOutprovinceObject(provinceIDs,
        ...
        PacOutProvinceObjectTable table = new PacOutProvinceObjectTable();
        for (Map.Entry<String, HashMap<String, PacOutProvinceObjectTable>> entry : form.getItems().entrySet()) {
            ...
            for (Map.Entry<String, PacOutProvinceObjectTable> entry1 : value.entrySet()) {
                PacOutProvinceObjectTable value1 = entry1.getValue();
                table.setNtmt(table.getNtmt() + value1.getNtmt());
                table.setMd(table.getMd() + value1.getMd());
                table.setMsm(table.getMsm() + value1.getMsm());
                table.setVcbtbc(table.getVcbtbc() + value1.getVcbtbc());
                table.setPnmt(table.getPnmt() + value1.getPnmt());
                table.setLao(table.getLao() + value1.getLao());
                table.setKhongthongtin(table.getKhongthongtin() + value1.getKhongthongtin());
                table.setKhac(table.getKhac() + value1.getKhac());
            }
        }
        form.setTable(table);
    ...
    @GetMapping(value = {"/pac-out-province-object/index.html"})
    public String actionIndex(Model model,
        ...
        PacOutProvinceObjectForm form = getData(updateTimeFrom, updateTimeTo,
                patientStatus,
        ...
        return "report/pac/out-province-object";
    }

    @GetMapping(value = {"/pac-out-province-object/excel.html"})
    public ResponseEntity<InputStreamResource> actionPositiveExcel(
        ...
        return exportExcel(new OutProvinceObjectExcel(form, EXTENSION_EXCEL_X));
    }

    @GetMapping(value = {"/pac-out-province-object/mail.html"})
    public String actionSendEmail(Model model, RedirectAttributes redirectAttributes,
        ...
        if (currentUser.getUser().getEmail() == null || "".equals(currentUser.getUser().getEmail())) {
            ...
            return redirect(UrlUtils.pacOutProvinceObject("index"));
        }
        PacOutProvinceObjectForm form = getData(updateTimeFrom, updateTimeTo,
                patientStatus,
                manageTimeFrom, manageTimeTo,
        ...
        sendEmailAtachmentExcel(
                ...
                context,
                new OutProvinceObjectExcel(form, EXTENSION_EXCEL_X));
    ...
    @GetMapping(value = {"/pac-out-province-object/pdf.html"})
    public ResponseEntity<InputStreamResource> actionPdf(
        ...
        return exportPdf(form.getFileName(), "report/pac/out-province-object-pdf.html", context);
    }
