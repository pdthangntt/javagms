 ...
 */
@RestController
public class DashboardPac14Controller extends DashboardController {
    ...
    @RequestMapping(value = "/dashboard-pac/d14-chart01.json", method = RequestMethod.POST)
    public Response<?> actionChart01(@RequestBody DashboardForm form) throws ParseException {
        ...
        Map<String, Map<String, Object>> data = dashboardPacImpl.getPac14Chart01(form.getProvinceID(), getParameter(form.getDistrict(), options.get("district")),fromDate, toDateConvert, getParameter(form.getGender(), options.get(ParameterEntity.GENDER)),
     ...
     * @return
     */
    @RequestMapping(value = "/dashboard-pac/d14-chart02.json", method = RequestMethod.POST)
    public Response<?> actionChart02(@RequestBody DashboardForm form) {
        ...
        Map<String, Map<String, Object>> data = dashboardPacImpl.getPacD14Chart02(form.getProvinceID(), form.getDistrict(), toTime.getTime(),
    ...
    @RequestMapping(value = "/dashboard-pac/d14-chart03.json", method = RequestMethod.POST)
    public Response<?> actionChart03(@RequestBody DashboardForm form) throws ParseException {
        ...
        Map<String, Map<String, Object>> data = dashboardPacImpl.getPacD14Chart03(form.getProvinceID(), 
    ...
    @RequestMapping(value = "/dashboard-pac/d14-chart04.json", method = RequestMethod.POST)
    public Response<?> actionChart04(@RequestBody DashboardForm form) throws ParseException {
        ...
        Map<String, Long> data = dashboardPacImpl.getPac14Chart04(form.getProvinceID(), getParameter(form.getDistrict(), options.get("district")), toDateConvert, getParameter(form.getGender(), options.get(ParameterEntity.GENDER)),
                getParameter(form.getModesOfTransmision(), options.get(ParameterEntity.MODE_OF_TRANSMISSION)),
                getParameter(form.getTestObjectGroup(), options.get(ParameterEntity.TEST_OBJECT_GROUP))
        );
     ...
     * @return
     */
    @RequestMapping(value = "/dashboard-pac/d14-chart05.json", method = RequestMethod.POST)
    public Response<?> actionChart05(@RequestBody DashboardForm form) {
        ...
        Map<String, Long> data = dashboardPacImpl.getPacD14Chart05(form.getProvinceID(), getParameter(form.getDistrict(), options.get("district")), fromTime.getTime(), toTime.getTime(),
                getParameter(form.getGender(), options.get(ParameterEntity.GENDER)),
                getParameter(form.getModesOfTransmision(), options.get(ParameterEntity.MODE_OF_TRANSMISSION)),
                getParameter(form.getTestObjectGroup(), options.get(ParameterEntity.TEST_OBJECT_GROUP)));
