...
@RestController
public class DashboardHtc22Controller extends DashboardController {
     ...
     * @return 
     */
    @RequestMapping(value = "/dashboard-htc/d22-chart01.json", method = RequestMethod.POST)
    public Response<?> actionChart01(@RequestBody DashboardForm form) {
        ...
        Map<String, Map<String, Object>> data = dashboardHtcImpl.getHtcChart01d22(form.getSite(), form.getServiceTest(), fromTime, toTime);
     ...
     * @return
     */
    @RequestMapping(value = "/dashboard-htc/d22-chart02.json", method = RequestMethod.POST)
    public Response<?> actionChart02(@RequestBody DashboardForm form) {
        ...
        Map<String, Map<String, Object>> data = dashboardHtcImpl.getHtcD22Chart02(form.getSite(), form.getServiceTest(), fromTime, toTime);
    ...
    /**
     * D22 Chart 03
     * Số xét nghiệm dương tính và nhận kết quả
     * 
     * @auth TrangBN
     * @param form
     * @return 
     */
    @RequestMapping(value = "/dashboard-htc/d22-chart03.json", method = RequestMethod.POST)
    public Response<?> actionChart03(@RequestBody DashboardForm form) {
        ...
        Map<String, Map<String, Object>> data = dashboardHtcImpl.getHtcD22Chart03(form.getSite(), form.getServiceTest(), fromTime, toTime);
     ...
     * @return
     */
    @RequestMapping(value = "/dashboard-htc/d22-chart04.json", method = RequestMethod.POST)
    public Response<?> actionChart04(@RequestBody DashboardForm form) {
        ...
        Map<String, Map<String, Object>> data = dashboardHtcImpl.getHtcD22Chart04(form.getSite(), form.getServiceTest(), fromTime, toTime);
     ...
     * @return
     */
    @RequestMapping(value = "/dashboard-htc/d22-chart05.json", method = RequestMethod.POST)
    public Response<?> actionChart05(@RequestBody DashboardForm form) {
        ...
        String fromTime = TextUtils.formatDate(fromDate, FORMATDATE);
        String toTime = TextUtils.formatDate(toDate, FORMATDATE);
        Map<String, Long> data = dashboardHtcImpl.getHtcD22Chart05(form.getSite(), form.getServiceTest(), fromTime, toTime);
     ...
     * @return 
     */
    @RequestMapping(value = "/dashboard-htc/d22-chart06.json", method = RequestMethod.POST)
    public Response<?> actionChart06(@RequestBody DashboardForm form) {
        ...
        Map<String, Long> data = dashboardHtcImpl.getHtcChart06d22(form.getSite(), form.getServiceTest(), fromTime, toTime);
