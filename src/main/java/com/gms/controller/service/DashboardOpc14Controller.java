 ...
 */
@RestController
public class DashboardOpc14Controller extends DashboardController {
    ...
    @RequestMapping(value = "/dashboard-opc/d14-chart05.json", method = RequestMethod.POST)
    public Response<?> actionChart05(@RequestBody DashboardForm form) {
        ...
        while (i <= currentQuater) {
            ...
            Map<String, Map<String, Object>> data = dashboardOpcImpl.getOpcD14Chart05(form.getSite(),
        ...
        Map<String, Map<String, Object>> data1 = dashboardOpcImpl.getOpcD14Chart05(form.getSite(),
    ...
    @RequestMapping(value = "/dashboard-opc/d14-chart03.json", method = RequestMethod.POST)
    public Response<?> actionChart03(@RequestBody DashboardForm form) throws ParseException {
        ...
        Map<String, Map<String, Object>> data = dashboardOpcImpl.getOpcD14Chart03(form.getSite(), form.getYear());
        Map<String, Map<String, Object>> sum = dashboardOpcImpl.getOpcD14Chart03Sum(form.getSite(), form.getYear());
    ...
    @RequestMapping(value = "/dashboard-opc/d14-chart04.json", method = RequestMethod.POST)
    public Response<?> actionChart04(@RequestBody DashboardForm form) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        String dateInString = String.format("%s-01-01", form.getYear());
        Date date = sdf.parse(dateInString);

        Map<String, Map<String, Object>> data = dashboardOpcImpl.getOpcD14Chart04(form.getSite(), form.getYear());
        Map<String, Map<String, Object>> sum = dashboardOpcImpl.getOpcD14Chart04Sum(form.getSite(), form.getYear());
        Calendar beginCalendar = Calendar.getInstance();
        beginCalendar.setTime(TextUtils.getFirstDayOfYear(date));
        Calendar finishCalendar = Calendar.getInstance();
        finishCalendar.setTime(TextUtils.getLastDayOfYear(date));
    ...
    @RequestMapping(value = "/dashboard-opc/d14-chart01.json", method = RequestMethod.POST)
    public Response<?> actionD14Chart01(@RequestBody DashboardForm form) throws ParseException {
        ...
        for (int min = minDate; min <= lastYear; min++) {
            item = new HashMap<>();
            Integer opcChrt01 = dashboardOpcImpl.getOpcD14Chart01(form.getSite(), String.valueOf(min));
    ...
    /**
     * Số BN đăng ký mới theo cơ sở
     *
     * @param form
     * @return
     * @throws ParseException
     */
    @RequestMapping(value = "/dashboard-opc/d14-chart02.json", method = RequestMethod.POST)
    public Response<?> actionD13Chart02(@RequestBody DashboardForm form) throws ParseException {
        ...
        Map<String, Integer> resultSet = dashboardOpcImpl.getOpcD14Chart02(form.getSite(), form.getYear());
        List<Map<String, Object>> result = new ArrayList<>();
        Map<String, Object> item = new HashMap<>();
