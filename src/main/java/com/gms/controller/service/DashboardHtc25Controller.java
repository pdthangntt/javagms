...
@RestController
public class DashboardHtc25Controller extends DashboardController {
     ...
     * @return 
     */
    @RequestMapping(value = "/dashboard-htc/d25-chart01.json", method = RequestMethod.POST)
    public Response<?> actionChart01(@RequestBody DashboardForm form) {
        ...
        Map<String, Map<String, Object>> data = dashboardHtcImpl.getHtcChart01d25(siteConfirms, form.getSite(), form.getServiceTest(), fromTime, toTime);
        ...
        while (beginCalendar.before(finishCalendar)) {
            ...
            if (item == null) {
                ...
                item.put("tongxntailuongvirus", Long.parseLong("0"));
            }
     ...
     * @return
     */
    @RequestMapping(value = "/dashboard-htc/d25-chart02.json", method = RequestMethod.POST)
    public Response<?> actionChart02(@RequestBody DashboardForm form) {
        ...
        Map<String, Map<String, Object>> data = dashboardHtcImpl.getHtcD25Chart02(siteConfirms, form.getSite(), form.getServiceTest(), fromTime, toTime);
        List<Map<String, Object>> result = new ArrayList<>();
        Map<String, Object> item;
        ...
        for (String districtName : districtList) {
            if(data.get(districtName) == null){
                ...
                item.put("tongxntailuongvirus", Long.valueOf("0"));
    ...
    /**
     * Số ca có kết quả XN tải lượng virus <1.000 bản sao/ml 
     * 
     * @auth TrangBN
     * @param form
     * @return 
     */
    @RequestMapping(value = "/dashboard-htc/d25-chart03.json", method = RequestMethod.POST)
    public Response<?> actionChart03(@RequestBody DashboardForm form) {
        ...
        Map<String, Map<String, Object>> data = dashboardHtcImpl.getHtcD25Chart03(form.getSite(), form.getServiceTest(), fromTime, toTime, confirmIDs);
     ...
     * @return
     */
    @RequestMapping(value = "/dashboard-htc/d25-chart04.json", method = RequestMethod.POST)
    public Response<?> actionChart04(@RequestBody DashboardForm form) {
        ...
        Map<String, Map<String, Object>> data = dashboardHtcImpl.getHtcD25Chart04(siteConfirms, form.getSite(), form.getServiceTest(), fromTime, toTime);
...
//        finishCalendar.add(Calendar.MONTH, 3);
     ...
     * @return
     */
    @RequestMapping(value = "/dashboard-htc/d25-chart05.json", method = RequestMethod.POST)
    public Response<?> actionChart05(@RequestBody DashboardForm form) {
        ...
        String fromTime = TextUtils.formatDate(fromDate, FORMATDATE);
        String toTime = TextUtils.formatDate(toDate, FORMATDATE);
        Map<String, Long> data = dashboardHtcImpl.getHtcD25Chart05(siteConfirms, form.getSite(), form.getServiceTest(), fromTime, toTime);
     ...
     * @return 
     */
    @RequestMapping(value = "/dashboard-htc/d25-chart06.json", method = RequestMethod.POST)
    public Response<?> actionChart06(@RequestBody DashboardForm form) {
        ...
        Map<String, Long> data = dashboardHtcImpl.getHtcChart06d25(form.getSite(), form.getServiceTest(), fromTime, toTime, confirmIDs);
