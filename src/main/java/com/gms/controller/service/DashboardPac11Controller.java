 ...
 */
@RestController
public class DashboardPac11Controller extends DashboardController {
    ...
    @RequestMapping(value = "/dashboard-pac/d11-chart01.json", method = RequestMethod.POST)
    public Response<?> actionChart01(@RequestBody DashboardForm form) throws ParseException {
        ...
        Map<String, Map<String, Object>> data = dashboardPacImpl.getPac11Chart01(form.getProvinceID(), getParameter(form.getDistrict(), options.get("district")), toDateConvert, getParameter(form.getGender(), options.get(ParameterEntity.GENDER)),
    ...
    @RequestMapping(value = "/dashboard-pac/d11-chart04.json", method = RequestMethod.POST)
...
//        String fromTime = TextUtils.formatDate(fromDate, FORMATDATE);
        ...
        Map<String, Long> data = dashboardPacImpl.getPac11Chart04(form.getProvinceID(), getParameter(form.getDistrict(), options.get("district")), toDateConvert, getParameter(form.getGender(), options.get(ParameterEntity.GENDER)),
                getParameter(form.getModesOfTransmision(), options.get(ParameterEntity.MODE_OF_TRANSMISSION)),
                getParameter(form.getTestObjectGroup(), options.get(ParameterEntity.TEST_OBJECT_GROUP))
        );
    ...
    /**
     * @author DSNAnh
     * Get data d11 chart02
     * @param form
     * @return
     */
    @RequestMapping(value = "/dashboard-pac/d11-chart02.json", method = RequestMethod.POST)
    public Response<?> actionChart02(@RequestBody DashboardForm form) {
        ...
        Map<String, Map<String, Object>> data = dashboardPacImpl.getPacD11Chart02(form.getProvinceID(), form.getDistrict(), toTime.getTime(),
    ...
    @RequestMapping(value = "/dashboard-pac/d11-chart03.json", method = RequestMethod.POST)
    public Response<?> actionChart03(@RequestBody DashboardForm form) throws ParseException {
        ...
        Map<String, Map<String, Object>> data = dashboardPacImpl.getPacD11Chart03(form.getProvinceID(),
    ...
    /**
     * @author DSNAnh
     * Get data d11 chart05
     * @param form
     * @return
     */
    @RequestMapping(value = "/dashboard-pac/d11-chart05.json", method = RequestMethod.POST)
    public Response<?> actionChart05(@RequestBody DashboardForm form) {
        ...
        Map<String, Long> data = dashboardPacImpl.getPacD11Chart05(form.getProvinceID(), getParameter(form.getDistrict(), options.get("district")), toTime.getTime(),
                getParameter(form.getGender(), options.get(ParameterEntity.GENDER)),
                getParameter(form.getModesOfTransmision(), options.get(ParameterEntity.MODE_OF_TRANSMISSION)),
                getParameter(form.getTestObjectGroup(), options.get(ParameterEntity.TEST_OBJECT_GROUP)));
