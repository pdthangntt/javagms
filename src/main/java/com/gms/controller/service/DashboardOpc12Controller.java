 ...
 */
@RestController
public class DashboardOpc12Controller extends DashboardController {
    ...
    @RequestMapping(value = "/dashboard-opc/d12-chart05.json", method = RequestMethod.POST)
    public Response<?> actionChart05(@RequestBody DashboardForm form) {
        ...
        while (i <= currentQuater) {
            ...
            Map<String, Map<String, Object>> data = dashboardOpcImpl.getOpcD12Chart05(form.getSite(),
    ...
    @RequestMapping(value = "/dashboard-opc/d12-chart06.json", method = RequestMethod.POST)
    public Response<?> actionChart06(@RequestBody DashboardForm form) {
        ...
        while (i <= currentQuater) {
            String key = String.format("%s/%s", i + 1, year);
            Map<String, Map<String, Object>> data = dashboardOpcImpl.getOpcD12Chart06(form.getSite(),
                    TextUtils.getFirstDayOfQuarter(i, year),
                    TextUtils.getLastDayOfQuarter(i, year),
                    key);
    ...
    @RequestMapping(value = "/dashboard-opc/d12-chart03.json", method = RequestMethod.POST)
    public Response<?> actionD12Chart03(@RequestBody DashboardForm form) throws ParseException {
        ...
        Map<String, Map<String, Object>> data = dashboardOpcImpl.getOpcD12Chart03(form.getSite(), form.getYear());
    ...
    @RequestMapping(value = "/dashboard-opc/d12-chart04.json", method = RequestMethod.POST)
    public Response<?> actionD12Chart04(@RequestBody DashboardForm form) throws ParseException {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        String dateInString = String.format("%s-01-01", form.getYear());
        Date date = sdf.parse(dateInString);

        Map<String, Map<String, Object>> data = dashboardOpcImpl.getOpcD12Chart04(form.getSite(), form.getYear());
    ...
    /**
     * Sô BN đang quản lý theo năm
     *
     * @param form
     * @return
     * @throws ParseException
     */
    @RequestMapping(value = "/dashboard-opc/d12-chart01.json", method = RequestMethod.POST)
    public Response<?> actionD12Chart01(@RequestBody DashboardForm form) throws ParseException {
        ...
        for (int min = minDate; min <= lastYear; min++) {
            item = new HashMap<>();
            Integer opcChrt01 = dashboardOpcImpl.getOpcD12Chart01(form.getSite(), String.valueOf(min));
    ...
    /**
     * Số bệnh nhân đang quản lý theo cơ sở
     *
     * @param form
     * @return
     * @throws ParseException
     */
    @RequestMapping(value = "/dashboard-opc/d12-chart02.json", method = RequestMethod.POST)
    public Response<?> actionD12Chart02(@RequestBody DashboardForm form) throws ParseException {
        ...
        Map<String, Integer> resultSet = dashboardOpcImpl.getOpcD12Chart02(form.getSite(), form.getYear());
        List<Map<String, Object>> result = new ArrayList<>();
        Map<String, Object> item = new HashMap<>();
