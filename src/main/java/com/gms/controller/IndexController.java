...
public class IndexController extends WebController {
    ...
    public String actionIndex(Model model, RedirectAttributes redirectAttributes,
        ...
        if (currentUser != null && currentUser.getUser().getChangePwd() != null && currentUser.getUser().getChangePwd() == true) {
            redirectAttributes.addFlashAttribute("warning", "Vui lòng đổi mật khẩu cho lần đăng nhập đầu tiên!");
